...
app.get('/view/:filename', (req, res) => {
    ...
    html += '</div></div>';
    html += '<div style="display:grid;grid-template-columns:250px 1fr 1fr;gap:24px;height:calc(100vh - 60px);min-height:500px" class="editor-grid">';
    html += '<script src="https://cdn.jsdelivr.net/npm/marked/marked.min.js"></script>';
    html += '<style>@media (max-width: 768px) {.editor-grid{grid-template-columns:1fr !important;grid-template-rows:auto 1fr 1fr !important;height:100dvh !important;min-height:700px !important}.editor-grid>div{height:100% !important;min-height:0 !important;flex:none !important}.toc-sidebar{margin-bottom:20px !important}}</style>';
